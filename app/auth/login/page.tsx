    ...
    <div className="min-h-screen bg-stone-50 flex items-center justify-center py-12 px-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-stone-600 mt-2">Sign in to your account to continue</p>
        </div>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            <p className="text-sm text-stone-600 mb-3">Just want to make a quick purchase?</p>
            <Button variant="outline" asChild>
              <Link href="/checkout?guest=true">Continue as Guest</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
